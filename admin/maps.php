...
//下一页或者上一页显示的新数据                                  
$start=($page-1)*10;                                                       //$num 与 $start 页数要一致 否则会错误；
//获取用户的信息
$sql ="select *  from essay limit $start,10";
...
// $sql ="DELETE FROM forum WHERE  id=$delet ";
// $result = $mysqli -> query($sql);
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="manage-users.php" ><i class="fa fa-users fa-fw"></i>管理与格言</a></li>
            <li><a href="../Home/preferences.html"><i class="fa fa-sliders fa-fw"></i>用户添加</a></li>
            <li><a href="maps.php" class="active"><i class="fa fa-map-marker fa-fw"></i>地图</a></li>
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr  align="center">
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">作者 <span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">更新时间<span class="caret"></span></a></td>
                     <td>编辑</td>
                    <!-- <td>Action</td> -->
                    <!-- <td>删除</td> -->
                  </tr>
                ...
                <!-- 用户查询 endforeach 自动补全 -->
                 ...
                 <?php foreach ($rows as $row):?>
                         ...
                         <td><a href="maps_edit.php?edit=<?php echo $row['id'];?>" class="templatemo-link">编辑</a></td>
                         <!-- <td><a href="maps.php?delet=<?php echo $row['id'];?>" class="templatemo-link">删除</a></td> -->
                         </tr>
                   <?php endforeach;?>
                    <tr align="center">
                ...
                <!-- 每一页展现五条数据在上面的sql语句中使用limit -->
                       <a href="maps.php?page=1" class="templatemo-blue-button">首页</a>
                       <a href="maps.php?page=<?php echo $page-1?>" class="templatemo-blue-button">上一页</a>
                       <a href="maps.php?page=<?php echo $page+1?>"class="templatemo-blue-button">下一页</a>
                       <a href="maps.php?page=<?php echo $totalpage; ?>"class="templatemo-blue-button">尾页</a>
                   </td>    
                </tr>    
